...
@section('content')
    ...
    <div class="ajax-panel" data-panel-url="{{ route('admin.bills.index') }}">
        <form method="GET" class="row g-2 mb-3">
            <div class="col-auto">
                <input type="text" data-ajax-param="search" name="search" value="{{ request('search') }}" class="form-control" placeholder="Bill #, Name, Admission ID or Phone">
            </div>
            <div class="col-auto">
        ...
        <div class="ajax-panel-results">
            @include('admin.bills.partials._bills-table', ['bills' => $bills])
        </div>
    </div>
